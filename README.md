...
Features
Wallet connection (MetaMask/Core). Fill in name, symbol, supply. Launch token + optional liquidity (80% in pool, 20% to you). Fee: 0.5 AVAX (test/real).

How to Use
Open https://m-fun.vercel.app/ in your browser.
Connect wallet on Fuji Testnet (Chain ID 43113).
...
Made by doru82. Testează și dă feedback on X!
